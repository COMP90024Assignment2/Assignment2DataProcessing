...
json_files = ["aussocial_homeless_data.json", "mastodonau_homeless_data.json"]

data = []
for file in json_files:
    with open('./json_file/'+file, "r", encoding="utf-8") as f:
        data.extend(json.load(f))  # Adds the data from the current file to the list

# Write the combined data to a new file
with open('./json_file/'+"combined_homeless_data.json", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False)
# Input file
input_file = './json_file/'+"combined_homeless_data.json"
...
json_files = ["aussocial_mortgage_data.json", "mastodonau_mortgage_data.json"]
...
# Write the combined data to a new file
with open('./json_file/'+"combined_mortgage_data.json", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False)
    input_file = './json_file/'+"combined_mortgage_data.json"
...
json_files = ["aussocial_rent_data.json", "mastodonau_rent_data.json"]
...
# Write the combined data to a new file
with open('./json_file/'+"combined_rent_data.json", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False)
    input_file = './json_file/'+"combined_rent_data.json"
...
json_files = ["aussocial_income_data.json", "mastodonau_income_data.json"]
...
# Write the combined data to a new file
with open('./json_file/'+"combined_income_data.json", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False)
    input_file = './json_file/'+"combined_income_data.json"
...
# Replace NaN values with 0
df_new = df_combined_new.fillna(0)
df_new.to_csv('./json_file/'+'combined_time_data.csv', index=False)
import json, csv
...
csv_file_path = './json_file/'+'combined_time_data.csv'
json_file_path = './json_file/'+'combined_time_data.json'
