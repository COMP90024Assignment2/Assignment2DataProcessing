...
def full_text_search(access_token):
    URL = "https://theblower.au/api/v2/search?q={}".format(keyword)
    headers = {
        "Authorization": "Bearer {}".format(access_token),
    }
...
if __name__ == "__main__":
    ...
    output_file = "theblower_homeless_data.json"
    results = []
...
if __name__ == "__main__":
    ...
    output_file = "theblower_mortgage_data.json"
    results = []
    for keyword in keywords:
        data = stream_federated_timeline_given_hashtag(access_token, keyword)
        results.extend(data)
...
if __name__ == "__main__":
    ...
    output_file = "theblower_rent_data.json"
    results = []
    for keyword in keywords:
        data = stream_federated_timeline_given_hashtag(access_token, keyword)
        results.extend(data)
...
if __name__ == "__main__":
    ...
    output_file = "theblower_income_data.json"
    results = []
    for keyword in keywords:
        data = stream_federated_timeline_given_hashtag(access_token, keyword)
        results.extend(data)
