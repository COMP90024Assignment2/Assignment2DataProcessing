...
def full_text_search(access_token):
    URL = "https://aus.social/api/v2/search?q={}".format(keyword)
    headers = {
        "Authorization": "Bearer {}".format(access_token),
    }
...
if __name__ == "__main__":
    ...
    output_file = "aussocial_homeless_data.json"
    results = []
...
if __name__ == "__main__":
    ...
    output_file = "aussocial_mortgage_data.json"
    results = []
    for keyword in keywords:
        data = stream_federated_timeline_given_hashtag(access_token, keyword)
        results.extend(data)
...
if __name__ == "__main__":
    ...
    output_file = "aussocial_rent_data.json"
    results = []
    for keyword in keywords:
        data = stream_federated_timeline_given_hashtag(access_token, keyword)
        results.extend(data)
...
if __name__ == "__main__":
    ...
    output_file = "aussocial_income_data.json"
    results = []
    for keyword in keywords:
        data = stream_federated_timeline_given_hashtag(access_token, keyword)
        results.extend(data)
